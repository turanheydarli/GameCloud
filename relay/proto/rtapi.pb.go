...
var file_rtapi_proto_msgTypes = make([]protoimpl.MessageInfo, 28)
var file_rtapi_proto_goTypes = []interface{}{
	(*Envelope)(nil),              // 0: gamecloud.Envelope
	(*Error)(nil),                 // 1: gamecloud.Error
	(*SessionDisconnect)(nil),     // 2: gamecloud.SessionDisconnect
	(*SessionHeartbeat)(nil),      // 3: gamecloud.SessionHeartbeat
	(*RoomCreate)(nil),            // 4: gamecloud.RoomCreate
	(*RoomJoin)(nil),              // 5: gamecloud.RoomJoin
	(*RoomLeave)(nil),             // 6: gamecloud.RoomLeave
	(*RoomData)(nil),              // 7: gamecloud.RoomData
	(*RoomPresence)(nil),          // 8: gamecloud.RoomPresence
	(*UserPresenceInfo)(nil),      // 9: gamecloud.UserPresenceInfo
	(*MatchmakerAdd)(nil),         // 10: gamecloud.MatchmakerAdd
	(*MatchmakerRemove)(nil),      // 11: gamecloud.MatchmakerRemove
	(*MatchmakerMatched)(nil),     // 12: gamecloud.MatchmakerMatched
	(*Status)(nil),                // 13: gamecloud.Status
	(*StatusUpdate)(nil),          // 14: gamecloud.StatusUpdate
	(*StatusPresence)(nil),        // 15: gamecloud.StatusPresence
	(*GameState)(nil),             // 16: gamecloud.GameState
	(*TurnChange)(nil),            // 17: gamecloud.TurnChange
	(*GameEnd)(nil),               // 18: gamecloud.GameEnd
	nil,                           // 19: gamecloud.Error.ContextEntry
	nil,                           // 20: gamecloud.RoomCreate.MetadataEntry
	nil,                           // 21: gamecloud.UserPresenceInfo.MetadataEntry
	nil,                           // 22: gamecloud.MatchmakerAdd.NumericPropertiesEntry
	nil,                           // 23: gamecloud.MatchmakerAdd.StringPropertiesEntry
	nil,                           // 24: gamecloud.Status.PresenceStatusesEntry
	nil,                           // 25: gamecloud.StatusUpdate.MetadataEntry
	nil,                           // 26: gamecloud.GameEnd.ScoresEntry
	nil,                           // 27: gamecloud.GameEnd.ResultMetadataEntry
	(*SessionConnect)(nil),        // 28: gamecloud.SessionConnect
	(*GameAction)(nil),            // 29: gamecloud.GameAction
	(*GameActionAck)(nil),         // 30: gamecloud.GameActionAck
...
var file_rtapi_proto_depIdxs = []int32{
	...
	28, // 1: gamecloud.Envelope.connect:type_name -> gamecloud.SessionConnect
	2,  // 2: gamecloud.Envelope.disconnect:type_name -> gamecloud.SessionDisconnect
	3,  // 3: gamecloud.Envelope.heartbeat:type_name -> gamecloud.SessionHeartbeat
	4,  // 4: gamecloud.Envelope.room_create:type_name -> gamecloud.RoomCreate
	5,  // 5: gamecloud.Envelope.room_join:type_name -> gamecloud.RoomJoin
	6,  // 6: gamecloud.Envelope.room_leave:type_name -> gamecloud.RoomLeave
	7,  // 7: gamecloud.Envelope.room_data:type_name -> gamecloud.RoomData
	8,  // 8: gamecloud.Envelope.room_presence:type_name -> gamecloud.RoomPresence
	10, // 9: gamecloud.Envelope.matchmaker_add:type_name -> gamecloud.MatchmakerAdd
	11, // 10: gamecloud.Envelope.matchmaker_remove:type_name -> gamecloud.MatchmakerRemove
	12, // 11: gamecloud.Envelope.matchmaker_matched:type_name -> gamecloud.MatchmakerMatched
	13, // 12: gamecloud.Envelope.status:type_name -> gamecloud.Status
	14, // 13: gamecloud.Envelope.status_update:type_name -> gamecloud.StatusUpdate
	15, // 14: gamecloud.Envelope.status_presence:type_name -> gamecloud.StatusPresence
	16, // 15: gamecloud.Envelope.game_state:type_name -> gamecloud.GameState
	29, // 16: gamecloud.Envelope.game_action:type_name -> gamecloud.GameAction
	30, // 17: gamecloud.Envelope.game_action_ack:type_name -> gamecloud.GameActionAck
	17, // 18: gamecloud.Envelope.turn_change:type_name -> gamecloud.TurnChange
	18, // 19: gamecloud.Envelope.game_end:type_name -> gamecloud.GameEnd
	19, // 20: gamecloud.Error.context:type_name -> gamecloud.Error.ContextEntry
	31, // 21: gamecloud.SessionHeartbeat.timestamp:type_name -> google.protobuf.Timestamp
	20, // 22: gamecloud.RoomCreate.metadata:type_name -> gamecloud.RoomCreate.MetadataEntry
	32, // 23: gamecloud.RoomData.sequence:type_name -> google.protobuf.Int32Value
	9,  // 24: gamecloud.RoomPresence.joins:type_name -> gamecloud.UserPresenceInfo
	9,  // 25: gamecloud.RoomPresence.leaves:type_name -> gamecloud.UserPresenceInfo
	21, // 26: gamecloud.UserPresenceInfo.metadata:type_name -> gamecloud.UserPresenceInfo.MetadataEntry
	22, // 27: gamecloud.MatchmakerAdd.numeric_properties:type_name -> gamecloud.MatchmakerAdd.NumericPropertiesEntry
	23, // 28: gamecloud.MatchmakerAdd.string_properties:type_name -> gamecloud.MatchmakerAdd.StringPropertiesEntry
	24, // 29: gamecloud.Status.presence_statuses:type_name -> gamecloud.Status.PresenceStatusesEntry
	25, // 30: gamecloud.StatusUpdate.metadata:type_name -> gamecloud.StatusUpdate.MetadataEntry
	9,  // 31: gamecloud.StatusPresence.presences:type_name -> gamecloud.UserPresenceInfo
	26, // 32: gamecloud.GameEnd.scores:type_name -> gamecloud.GameEnd.ScoresEntry
	27, // 33: gamecloud.GameEnd.result_metadata:type_name -> gamecloud.GameEnd.ResultMetadataEntry
