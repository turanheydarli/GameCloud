...
namespace GameCloud.Persistence.Migrations
{
    ...
    [Migration("20250314224019_LeaderboardEntitiesAdded")]
    partial class LeaderboardEntitiesAdded
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GameCloud.Domain.Entities.Leaderboards.Leaderboard", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("ResetStrategy")
                        .HasColumnType("text");
                    ...
                    b.ToTable("Leaderboards", "gc");
                });

            modelBuilder.Entity("GameCloud.Domain.Entities.Leaderboards.LeaderboardArchive", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<JsonDocument>("Rankings")
                        .IsRequired()
                        .HasColumnType("jsonb");
                    ...
                    b.ToTable("LeaderboardArchives", "gc");
                });

            modelBuilder.Entity("GameCloud.Domain.Entities.Leaderboards.LeaderboardRecord", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("LeaderboardRecords", "gc");
                });
            ...
            modelBuilder.Entity("GameCloud.Domain.Entities.Matchmaking.Match", b =>
                {
                    ...
                    b.Property<JsonDocument>("MatchState")
                        .IsRequired()
                        .HasColumnType("jsonb");
                    ...
                    b.Property<JsonDocument>("PlayerStates")
                        .IsRequired()
                        .HasColumnType("jsonb");
                    ...
                    b.Property<JsonDocument>("TurnHistory")
                        .IsRequired()
                        .HasColumnType("jsonb");
            ...
            modelBuilder.Entity("GameCloud.Domain.Entities.Matchmaking.MatchAction", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");

                    b.Property<JsonDocument>("ActionData")
                        .IsRequired()
                        .HasColumnType("jsonb");
            ...
            modelBuilder.Entity("GameCloud.Domain.Entities.Rooms.Room", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("GameCloud.Domain.Entities.Rooms.RoomConfig", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<bool>("PersistState")
                        .HasColumnType("boolean");

                    b.Property<Guid?>("RoomId")
                        .HasColumnType("uuid");

                    b.Property<int>("TurnTimerInSeconds")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("GameCloud.Domain.Entities.Leaderboards.LeaderboardArchive", b =>
                {
                    b.HasOne("GameCloud.Domain.Entities.Leaderboards.Leaderboard", "Leaderboard")
                        .WithMany("Archives")
            ...
            modelBuilder.Entity("GameCloud.Domain.Entities.Rooms.RoomConfig", b =>
                {
                    b.HasOne("GameCloud.Domain.Entities.Rooms.Room", null)
                        .WithOne("Config")
                        .HasForeignKey("GameCloud.Domain.Entities.Rooms.RoomConfig", "RoomId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
