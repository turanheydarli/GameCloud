...
public class InvalidUserClaimsExceptionHandler(IProblemDetailsService problemDetailsService) : IExceptionHandler
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        if (exception is not InvalidUserClaimsException invalidUserClaimsException)
        {
            return false;
        }
