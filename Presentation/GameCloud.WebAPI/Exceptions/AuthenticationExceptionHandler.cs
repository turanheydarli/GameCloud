...
public class InvalidCredentialExceptionHandler(IProblemDetailsService problemDetailsService) : IExceptionHandler
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        if (exception is not InvalidCredentialException invalidCredentialsException)
        {
            return false;
        }
